...
## Programming problems
  - [Programming problems](#programming-problems)
    ...
    - [Longest common prefix]([#build-the-on-chain-program](https://github.com/ratulb/programming_interview_questions_in_rust/blob/master/longest_common_prefix/src/lib.rs))
